...
// Add a menu to the active document including all commands. 

function onOpen(e) {

  //If the user has already used the tool in a different document, 
  ...
  //Creates the Menu containing all commands. 
